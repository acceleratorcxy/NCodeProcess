...
- **当前基线**：**198 项全部通过**（2026-08-05 合并精简后 159 项；WP-01 +4、WP-02 +4、WP-04 +5、WP-05 +8、二级页面修复 +2、WP-06 +3、样例刀具回归 +3、刀具类型拆分 +3、WP-07 校验缺口/F 上离群 +7 项后为 198 项），全量运行约 35 秒。
...
6. **运行与验证**：改动后先跑目标模块，再跑全量回归；保持基线 **198 项全绿**。
