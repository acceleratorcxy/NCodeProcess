...
- 测试基线：`NCodeProcess-测试指南.md`（172 项）、`NCodeProcessReportViewer-测试指南.md`（6 项）
...
Expected: 159 项全部通过（WP-01/WP-02/WP-04 完成后基线更新为 172 项，测试指南同步）。
...
5. **测试基线**：主工具 172 项、查看器 6 项为基线；每个 WP 完成后同步更新测试指南与需求文档第 15 节。
